...
enum
{
  ...
  ST_ALLOCATED = 1,     /**< Dev memory allocated in FabricCreateDevice() */
...
class Device {
 ...
 public:
  ...
  bool initiated{};           /**< Set when FabricCreateDevice() called */
...
Device* FabricCreateDevice(JobControlRecord* jcr, DeviceResource* device);
